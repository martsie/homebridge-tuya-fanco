...
class SimpleFanLightAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
		...
		const characteristicLightOn = service.getCharacteristic(Characteristic.On)
            .updateValue(dps[this.dbLightOn])
            .on('get', this.getState.bind(this, this.dbLightOn))
            .on('set', this.setState.bind(this, this.dbLightOn));
